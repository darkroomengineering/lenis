;(function (factory) {
  ...
  class Animate {
    ...
    advance(deltaTime) {
      ...
      ;(_a = this.onUpdate) === null || _a === void 0
        ? void 0
        : _a.call(this, this.value, completed)
    }
    stop() {
      this.isRunning = false
    }
  ...
  class Dimensions {
    ...
    destroy() {
      var _a, _b
      ;(_a = this.wrapperResizeObserver) === null || _a === void 0
        ? void 0
        : _a.disconnect()
      ;(_b = this.contentResizeObserver) === null || _b === void 0
        ? void 0
        : _b.disconnect()
  ...
  class Emitter {
    ...
    on(event, callback) {
      ...
      ;((_a = this.events[event]) === null || _a === void 0
        ? void 0
        : _a.push(callback)) || (this.events[event] = [callback])
      return () => {
        var _a
        this.events[event] =
          (_a = this.events[event]) === null || _a === void 0
      ...
      this.onTouchMove = (event) => {
        ...
        const deltaX =
          -(
            clientX -
            ((_b =
              (_a = this.touchStart) === null || _a === void 0
                ? void 0
                : _a.x) !== null && _b !== void 0
              ? _b
              : 0)
        ...
        const deltaY =
          -(
            clientY -
            ((_d =
              (_c = this.touchStart) === null || _c === void 0
                ? void 0
                : _c.y) !== null && _d !== void 0
              ? _d
              : 0)
          ...
          !!composedPath.find((node) => {
            ...
            return (
              ...
              ((typeof prevent === 'function' &&
                (prevent === null || prevent === void 0
                  ? void 0
                  : prevent(node))) ||
                ((_a = node.hasAttribute) === null || _a === void 0
                  ? void 0
                  : _a.call(node, 'data-lenis-prevent')) ||
                (isTouch &&
                  ((_b = node.hasAttribute) === null || _b === void 0
                    ? void 0
                    : _b.call(node, 'data-lenis-prevent-touch'))) ||
                (isWheel &&
                  ((_c = node.hasAttribute) === null || _c === void 0
                    ? void 0
                    : _c.call(node, 'data-lenis-prevent-wheel'))) ||
                (((_d = node.classList) === null || _d === void 0
                  ? void 0
                  : _d.contains('lenis')) &&
                  !((_e = node.classList) === null || _e === void 0
                    ? void 0
                    : _e.contains('lenis-stopped'))))
            )
          })
        )
          return
    ...
    scrollTo(
      ...
      if (
        ...
        if (typeof target === 'string') {
          ...
          (target === null || target === void 0 ? void 0 : target.nodeType)
        ) {
          node = target
        }
        if (node) {
