...
class VirtualScroll {
  constructor(i, { wheelMultiplier: e = 1, touchMultiplier: s = 1 }) {
    ;(this.lastDelta = { x: 0, y: 0 }),
      ...
      (this.onTouchMove = (t) => {
        var i, e, s, o
        const { clientX: n, clientY: l } = t.targetTouches
            ? t.targetTouches[0]
            : t,
          r =
            -(
              ...
              (null !==
                (e =
                  null === (i = this.touchStart) || void 0 === i
                    ? void 0
                    : i.x) && void 0 !== e
                ? e
                : 0)
          ...
          h =
            -(
              ...
              (null !==
                (o =
                  null === (s = this.touchStart) || void 0 === s
                    ? void 0
                    : s.y) && void 0 !== o
                ? o
                : 0)
        ...
        ;(this.touchStart.x = n),
          (this.touchStart.y = l),
          (this.lastDelta = { x: r, y: h }),
          this.emitter.emit('scroll', { deltaX: r, deltaY: h, event: t })
      }),
      (this.onTouchEnd = (t) => {
      ...
      (this.onWheel = (i) => {
        ...
        ;(e *= 1 === o ? t : 2 === o ? this.windowWidth : 1),
